...
class PolicyModel(nn.Module):
    ...
    def __init__(self, context_encoder, knowledge_encoder, path_encoder, n_layers, n_heads, lm_hidden_size, ffn_size,
                 fc_hidden_size, n_goals, n_topics, attention_dropout=0.2, relu_dropout=0.2, drop_out=0.5):
        super().__init__()
