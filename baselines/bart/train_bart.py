...
from baselines.bart.utils import convert_example_to_feature_for_bart_response_generation
...
if __name__ == '__main__':
    ...
    train_torch_dataset = BaseTorchDataset(
        ...
        device=device,
        convert_example_to_feature=convert_example_to_feature_for_bart_response_generation,
        is_test=False,
        is_gen=True,
