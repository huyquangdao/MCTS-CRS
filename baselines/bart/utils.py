...
def convert_example_to_feature_for_bart_response_generation(tokenizer, instance, max_sequence_length=512,
...
def generate_response_bart(generation_model, tokenizer, state, max_sequence_length, max_gen_length=50,
    ...
    input_ids, _ = convert_example_to_feature_for_bart_response_generation(tokenizer=tokenizer, instance=state,
